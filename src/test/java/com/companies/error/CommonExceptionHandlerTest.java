...
import com.companies.config.JacksonConfig;
...
public class CommonExceptionHandlerTest {
    ...
    public void shouldReturn422OnJavaxValidationError() throws Exception {
        ...
        assertThat(errors.getErrors())
                .hasSize(1)
                .containsOnly(new RequestError("NotNull", "some_field may not be null", "some_field", null));
    }
    ...
    public void shouldReturn422OnJavaxEmptyStringValidationError() throws Exception {
        ...
        assertThat(errors.getErrors())
                .hasSize(1)
                .containsOnly(new RequestError("NotEmpty", "some_field may not be empty", "some_field", null));
    }
